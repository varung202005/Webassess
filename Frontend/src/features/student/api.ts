...
export const studentApi = {
  portal: () => get<StudentPortal>("/api/v1/student/portal"),
  ...
  logEvent: (attemptId: string, eventType: string) =>
    post(`/api/v1/exam-attempts/${attemptId}/log-event?event_type=${encodeURIComponent(eventType)}`),
