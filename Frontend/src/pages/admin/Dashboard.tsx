...
.quick-actions{display:flex;gap:8px;align-items:center;flex-wrap:wrap;margin-bottom:18px}.action-btn{height:38px;border:1px solid #e8e9ef;border-radius:10px;background:#fff;display:flex;align-items:center;gap:8px;padding:0 12px;font:750 13px var(--font);color:#222536;cursor:pointer;text-align:left;transition:.15s}.action-btn:hover{border-color:#f5b8c4;background:#fff7f9}.action-btn i{color:#9d102d;font-size:17px;flex:none}
...
.user-layout{display:grid;grid-template-columns:minmax(0,1fr) 280px;gap:16px}.side-panel{display:grid;gap:12px}.rule-box{border:1px solid #e8e9ef;border-radius:14px;background:#fff;padding:14px}.rule-box h4{margin:0 0 8px;font-size:13px}.rule-box p{margin:0;color:#6b6b7b;font-size:12.5px;line-height:1.55}.rule-list{display:grid;gap:8px;margin:10px 0 0}.rule-list span{display:flex;gap:8px;align-items:flex-start;color:#6b6b7b;font-size:12.5px;line-height:1.4}.rule-list i{color:#9d102d;margin-top:1px}.fab{position:fixed;right:28px;bottom:28px;width:52px;height:52px;border:0;border-radius:16px;background:#b31234;color:#fff;box-shadow:0 12px 30px rgba(112,12,35,.24);display:grid;place-items:center;font-size:24px;cursor:pointer;z-index:25}.fab:hover{background:#9d102d}
        ...
        <div className="side-panel">
          <div className="rule-box">
            ...
            <div className="rule-list">
              <span><i className="ti ti-check" /> Admin, Faculty and Student accounts are created explicitly.</span>
              <span><i className="ti ti-check" /> CSV imports generate missing passwords and email credentials when SMTP is configured.</span>
              <span><i className="ti ti-check" /> Candidate is temporary and managed through exam assignment.</span>
            </div>
            <div className="toolbar" style={{ marginTop: 12 }}>
              <button className="btn btn-primary" onClick={() => openCreateAccount(userRoleTab)}>
                <i className="ti ti-upload" /> Upload
              </button>
              <button className="btn btn-secondary" onClick={() => setActiveTab("candidates")}>
                <i className="ti ti-user-plus" /> Candidates
              </button>
            </div>
          </div>
        </div>
