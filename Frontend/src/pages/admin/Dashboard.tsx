...
.admin-brand.student-brand{border-bottom-color:rgba(255,255,255,.15)}.admin-mark.brand-mark{position:relative;overflow:hidden;padding:0;background:#fff;box-shadow:none}.admin-mark.brand-mark img{display:block;width:100%;height:100%;object-fit:contain}
...
.admin-sidebar{position:fixed!important;inset:0 auto 0 0!important;height:100dvh!important;overflow:hidden!important}.admin-sidebar .admin-brand{flex-shrink:0}.admin-sidebar .admin-nav{min-height:0;flex:1 1 0;overscroll-behavior:contain}.admin-sidebar .admin-side-bottom{margin-top:auto;flex-shrink:0}
